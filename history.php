...
<body>
    <header class="header">
        <div class="container">
            ...
            <nav>
                <ul>
                    <li><a href="trackyourprocess.php" class="logout">Track Your Progress</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="content-section">
                    ...
                    <p>The word history is derived from the ancient Greek word ‘Historia’, which
translates into ‘an inquiry. Thus the knowledge acquired by the investigation of
the events of the past is history. In simple terms, it is the enquiry of the
‘human past’.</p>
<h2>Classification of the timeline in historical studies</h2>
<p>Historians have classified the study of history into the following divisions based
on the tools used in different ages, knowledge of writing and modes of
communication: -</p>
<ol>
    <li>Pre-history – It consists of the events that occurred before the invention
    of writing. It is further classified as: -
<ul>
    <li>Palaeolithic age or the Old Stone Age: The Greek word ‘lith’ refers
to stone. It was the time when people first started using stone
tools. It extends from 2,500,000 Million years ago (MYA) to 11,700
years ago. In this age, the tools used were unpolished and rough
stones. This This age features the evolution of proto-humans to
humans.</li>
<li>Mesolithic Period, or the Middle Stone Age – extends from 11,700
years ago to 6000 BCE. The time frame is different for different
regions in the world. There is a prevalence of microliths (miniature
stone tools) in this age, and by its end, people had started
domesticating animals and cultivating plants.</li>
<li>Neolithic Period or the New Stone Age: The beginning of
cultivation and the end of the hunting and gathering phase is the
distinguishing feature of this age. It generally extends from 6000
BCE to 1000 BCE in most regions of the world. People used
microlithic blades, polished stones, and weapons made of bones.
People started living in rectangular or circular houses.</li>
<li>Chalcolithic Period or the Stone-Copper Age: The prefix ‘Chalco’
comes from the Greek word khalkos, meaning ‘copper’. At around
3000 BCE, people started using copper along with stone tools. This
was the first time when metal was used. This led to an
improvement in cultivation techniques, and people began growing

cereals, pulses and cotton, apart from increased domestication of
animals.</li>
</ul>
</li>
<li>Proto-history – refers to the civilisation phase of history before the
invention of writing. Such civilisations find mention in the writings of
other contemporary literate cultures. Even those cultures that had some
mode of written communication but did not develop into fully functional
languages are also classified as Proto-historical periods.
For example – the Indus valley civilisation (IVC) valley script remains
deciphered, but it is mentioned in the writings of the Mesopotamian
civilisation. Therefore, it is classified as a proto-historical civilisation.</li>
<li>History - It consists of events that occurred after the invention of writing.
Therefore, it enables us to reconstruct the actual events of the past on
the basis of written records and archaeological sources. For example -
the Edicts of the Ashokan period are an essential source for
reconstructing the society, religion, polity and economy of the past.</li>
</ol>
            ...
            $('#question-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        setTimeout(function() {
                            loadQuestion(currentQuestionIndex);
                        }, 2000); // Delay loading the next question to give time for the user to see the answer result
                    }
                });
            });
